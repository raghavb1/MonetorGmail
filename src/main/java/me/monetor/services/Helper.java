...
public class Helper {
	...
	public StringBuffer executePost(String url, List<NameValuePair> urlParameters) throws ClientProtocolException, IOException{
	...
	private StringBuffer getStringBufferFromHttpResponse(HttpResponse response) throws IllegalStateException, IOException{
